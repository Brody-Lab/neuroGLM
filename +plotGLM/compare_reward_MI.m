function compare_reward_MI(stats1,stats2,params)
    ...
    for i=1:2
        ...
        subplot(1,5,i);
        significance_histogram(reward_MI_max{i},reward_MI_max_pval{i});        
    ...
    set(gca,P.axes_properties{:},'xtick',[ 1 2],'xlim',[0.5 2.5],'xticklabel',inputnames,'ylim',[-0.1 0.1],'ytick',[-0.1:0.05:0.1]);
    ylabel('Reward MI');
