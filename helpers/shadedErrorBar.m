...
%edgeColor=col+(1-col)*0.55; not used anymore
...
% replace patch with fill if xP or yP are datetimes since fill supports
% them but patch doesn't and the outputs are v similar
...
%H.edge(1)=plot(x,lE,'-','color',edgeColor); these two lines removed by AGB because looks better without patch edges
